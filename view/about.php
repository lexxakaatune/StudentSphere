<?php render('layout/header'); ?>
  ...
  <section class="about about__hero">
    <figure class="about__figure">
      <img src="./assets/images/about-big.jpg" alt="random now" width="800" height="1280">
      <figcaption class="about__figcaption">
        <span class="nowrap"><b>25</b></span>
        <small class="nowrap">years of</small>
        <small class="nowrap">experience</small> 
      </figcaption>
      <img src="./assets/images/about-small.jpg" alt="random now" width="400" height="400">
    </figure>
    <aside class="about__aside">
      <h2 class="h2">ABOUT US</h2>
      <p class="about__p big-text">
  ...
  <main class="main">
    <h2 class="about__h2">At InvestXpress markets, our values are in service of our clients. We strive to uphold our values everday.</h2>
    <section class="card__section">
      <figure class="about__card">
        <figcaption class="bold">Safety first</figcaption>
        <figcaption>InvestXpress is a safety first organisation</figcaption>
        <img src="./assets/images/SafetyFirst_XL__654x628.png" alt="safety first" width="654" height="628" title="your safety with us is our priority"  loading="lazy">
      </figure>
      <figure class="about__card">
        <figcaption class="bold">Participation is power</figcaption>
        <figcaption>At InvestXpress the rich don't get a better deal</figcaption>
        <img src="./assets/images/Participation_XL__988x1053.png" alt="Participation is power" width="988" height="1053" title="working together not just to earn but to create"  loading="lazy">
      </figure>
      <figure class="about__card">
        <figcaption class="bold">Radial clients focus</figcaption>
        <figcaption>We exist to make our clients happy</figcaption>
        <img src="./assets/images/RadicalCustomer_XL__988x1100.png" alt="Radical clients" width="988" height="1100" title="if you are happy then we are happy" loading="lazy">
      </figure>
      <figure class="about__card">
        <figcaption class="bold">First-principles thinking</figcaption>
        <figcaption>we make bold bets and callenge the status quo</figcaption>
        <img src="./assets/images/FirstPrinciples_XL__988x970.png" alt="First-principles thinking" width="988" height="970" title="bold yet best choices behind for the future" loading="lazy">
      </figure>
    </section>

    <article class="about__article">
      <h2 class="about__h2">We believe the financial system should be built to work for everyone. That's why we create products that let you start investing at your own pace, on your own terms.</h2>

      <section class="about about__section">
        <figure>
          <img src="./assets/images/explore__.svg" alt="explore">
        </figure>
        <aside class="about__aside">
      ...
      <section class="about about__section">
        ...
        <figure>
            <img src="./assets/images/bear-bulls__.svg" alt="bear and bulls">
        </figure>      
      </section>
      <section class="about about__section">
        <figure>
            <img src="./assets/images/mecha__.svg" alt="macha">
        </figure>
        <aside class="about__aside">
          <h3>More for our investors to learn</h3>
          <p>We're redefining what it means to learn about finance and that means education resources that are built for today. <a href="#">Learn More</a></p>
      ...
      <section class="about about__section">
        ...
        <figure>
          <img src="./assets/images/robo-hand__.svg" alt="robo hand">
        </figure>
      </section>
    </article>

    <article class="founders">
      <h2 class="big-text center">Meet Our Founders</h2>
      <section class="about">
        <figure class="about__figure-profile"></figure>
        <aside class="about__aside">
